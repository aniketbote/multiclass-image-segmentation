...
def get_unet_128(input_shape=(128, 128, 3),
                 num_classes=1, final_activation = 'softmax'):
    ...
    classify = Conv2D(num_classes, (1, 1), activation=final_activation)(up1)
...
def get_unet_256(input_shape=(256, 256, 3),
    ...
    classify = Conv2D(num_classes, (1, 1), activation=final_activation)(up0)
...
def get_unet_512(input_shape=(512, 512, 3),
    ...
    classify = Conv2D(num_classes, (1, 1), activation=final_activation)(up0a)
...
def get_unet_1024(input_shape=(1024, 1024, 3),
    ...
    classify = Conv2D(num_classes, (1, 1), activation=final_activation)(up0b)
